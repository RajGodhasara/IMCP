<%-- 
    Document   : 404
    Created on : Dec 23, 2016, 3:22:57 PM
    Author     : GOPIRAJ
--%>
...
<!-- Mirrored from swlabs.co/edugate/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Dec 2016 05:52:05 GMT -->
<head><title>Edugate | </title>
    <meta charset="utf-8">
                ...
                <div class="page-404">
                    <div class="container">
                        <div class="wrapper-404">
                            <div class="title-404"><p class="signal">Oops, This Page Could Not Be Found!</p><span class="sub">The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.</span>

                                <p class="warning">404</p>
                                <button onclick="window.location.href='index.html'" class="btn btn-404"><span>HOME</span></button>
                            </div>
                        </div>
                    </div>
                </div>
