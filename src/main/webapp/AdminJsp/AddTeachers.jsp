...
<form:form method="POST" id="Form" commandName="command" action="admin_add_teachers_insert" enctype="multipart/form-data">
    <table>
        <tr>
            ...
            <td>
                <div class="col-xs-5">
                    <form:input path="name" name="name" id="name" cssClass="form-control" placeholder="Faculty Name"/>
                </div>
            </td>
            <td>
            ...
            <td>
                <div class="col-xs-5">
                    <form:input path="thought" name="thought" id="thought" cssClass="form-control" placeholder="Faculty Quote"/>
                </div>
            </td>
        ...
        <tr>
            ...
            <td>
                <div class="col-xs-5">
                    <form:input path="designation" name="designation" id="designation" cssClass="form-control" placeholder="Faculty Designation"/>
                </div>
            </td>
            <td>
            ...
            <td>
                <div class="col-xs-5">
                    <form:input path="facebook" name="facebook" id="facebook" cssClass="form-control" placeholder="Faculty Facebook Link"/>
                </div>
            </td>
            ...
            <td>
                <div class="col-xs-5">
                    <form:input path="gmail" name="gmail" id="gmail" cssClass="form-control" placeholder="Faculty Gmail Link"/>
                </div>
            </td>
        ...
        <tr>
            ...
            <td>
                <div class="col-xs-5">
                    <form:input path="twitter" name="twitter" id="twitter" cssClass="form-control" placeholder="Faculty Twitter Link"/>
                </div>
            </td>
            <td>
...
<div style="margin-top: 80px; margin-left: 100px;">
    <input type="button" id="buttondelete"  onclick="deleteSelectedTeachers()" value="Delete Selected Teachers" class="btn btn-primary"/>
</div>